About flux-restful-client-feedstock
===================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/flux-restful-client-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/flux-restful-client-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add flux-restful-client
# for installing globally
pixi global install flux-restful-client
```
...
It is possible to list all of the versions of `flux-restful-client` available on your platform:
...
```
pixi search flux-restful-client --channel conda-forge
```
